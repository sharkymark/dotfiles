...
- when Nuon MCP is available, do not shell out to python, jq, or other scripts to parse MCP dumps; read tool results and call narrower MCP tools if a response is large
